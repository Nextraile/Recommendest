...
<main class="min-h-screen py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="bg-gray-50 p-6 rounded-lg mb-8">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between">
                        <span>Harga Tiket (<?php echo $booking['jumlah_orang']; ?> orang)</span>
                        <span>Rp <?php echo number_format($booking['harga_tiket'] * $booking['jumlah_orang'], 0, ',', '.'); ?></span>
                    </div>
                    <div class="flex justify-between text-accent">
                        <span>Diskon (<?php echo $booking['diskon']; ?>%)</span>
                        <span>-Rp <?php echo number_format(($booking['harga_tiket'] * $booking['jumlah_orang'] * $booking['diskon']) / 100, 0, ',', '.'); ?></span>
                    </div>
                    <div class="flex justify-between text-accent">
                        <span>Cashback</span>
            ...
            <form method="POST" action="riwayat-transaksi.php">
