        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            <div class="flex justify-between items-start mb-8">
                <div>
                    ...
                    <p class="text-gray-600">Booking ID: #<?php echo str_pad($booking['id'], 6, '0', STR_PAD_LEFT); ?></p>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            ...
                            <span class="font-semibold"><?php echo $booking['destinasi_nama']; ?></span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            <span class="text-gray-600">Tanggal Booking:</span>
                            <span class="font-semibold"><?php echo date('d F Y H:i', strtotime($booking['tanggal_booking'])); ?></span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            <span class="text-gray-600">Tanggal Berangkat:</span>
                            <span class="font-semibold"><?php echo date('d F Y', strtotime($booking['tanggal_berangkat'])); ?></span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            <span class="text-gray-600">Jumlah Orang:</span>
                            <span class="font-semibold"><?php echo $booking['jumlah_orang']; ?> orang</span>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            ...
                            <span class="font-semibold"><?php echo $booking['email']; ?></span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            <span class="text-gray-600">Telepon:</span>
                            <span class="font-semibold"><?php echo $booking['telp']; ?></span>
                        </div>
                        <?php if (!empty($booking['note'])): ?>
                        <div class="py-2 border-b border-gray-200">
                            <span class="text-gray-600 block mb-1">Catatan:</span>
                            <span class="font-semibold"><?php echo $booking['note']; ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="bg-gray-50 p-6 rounded-lg mb-8">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between">
                        <span>Subtotal</span>
                        <span>Rp <?php echo number_format($booking['total'] + ($booking['total'] * $booking['diskon'] / 100) + $booking['cashback'], 0, ',', '.'); ?></span>
                    </div>
                    <div class="flex justify-between text-accent">
                        <span>Diskon (<?php echo $booking['diskon']; ?>%)</span>
                        <span>-Rp <?php echo number_format($booking['total'] * $booking['diskon'] / 100, 0, ',', '.'); ?></span>
                    </div>
                    <div class="flex justify-between text-accent">
                        <span>Cashback</span>
                        <span>-Rp <?php echo number_format($booking['cashback'], 0, ',', '.'); ?></span>
                    </div>
                    <hr class="my-2">
                    <div class="flex justify-between text-lg font-bold text-dark">
                        <span>Total Dibayar</span>
                        <span>Rp <?php echo number_format($booking['total'], 0, ',', '.'); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex gap-4">
                <button onclick="window.print()" 
                        class="flex-1 bg-primary text-white py-3 px-6 rounded-lg font-semibold hover:bg-opacity-90 transition-colors">
                    Cetak Tiket
                </button>
